...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create skills
        skills_data = [
            {'name': 'Python', 'category': 'programming', 'proficiency': 'expert', 'level': 9, 
             'description': 'Expert in Python development', 'years_of_experience': 7.0, 
             'icon': 'fab fa-python', 'is_featured': True, 'order': 1},
            {'name': 'Django', 'category': 'framework', 'proficiency': 'expert', 'level': 9, 
             'description': 'Advanced Django development', 'years_of_experience': 6.0, 
             'icon': 'fab fa-python', 'is_featured': True, 'order': 2},
            {'name': 'JavaScript', 'category': 'programming', 'proficiency': 'advanced', 'level': 8, 
             'description': 'Proficient in modern JavaScript', 'years_of_experience': 5.0, 
             'icon': 'fab fa-js', 'is_featured': True, 'order': 3},
            {'name': 'React', 'category': 'framework', 'proficiency': 'advanced', 'level': 8, 
             'description': 'Building modern React applications', 'years_of_experience': 4.0, 
             'icon': 'fab fa-react', 'is_featured': True, 'order': 4},
            {'name': 'PostgreSQL', 'category': 'database', 'proficiency': 'advanced', 'level': 8, 
             'description': 'Database design and optimization', 'years_of_experience': 6.0, 
             'icon': 'fas fa-database', 'is_featured': True, 'order': 5},
            {'name': 'Docker', 'category': 'tool', 'proficiency': 'advanced', 'level': 8, 
             'description': 'Container orchestration and deployment', 'years_of_experience': 5.0, 
             'icon': 'fab fa-docker', 'is_featured': True, 'order': 6},
            {'name': 'Git', 'category': 'tool', 'proficiency': 'expert', 'level': 9, 
             'description': 'Version control and collaboration', 'years_of_experience': 7.0, 
             'icon': 'fab fa-git', 'is_featured': False, 'order': 7},
            {'name': 'AWS', 'category': 'tool', 'proficiency': 'intermediate', 'level': 7, 
             'description': 'Cloud infrastructure and services', 'years_of_experience': 3.0, 
             'icon': 'fab fa-aws', 'is_featured': False, 'order': 8},
            {'name': 'English', 'category': 'language', 'proficiency': 'expert', 'level': 9, 
             'description': 'Fluent in technical and business English', 'years_of_experience': 10.0, 
             'is_featured': False, 'order': 9},
            {'name': 'French', 'category': 'language', 'proficiency': 'expert', 'level': 10, 
             'description': 'Native speaker', 'years_of_experience': 30.0, 
...
''',
        ...
        self.stdout.write(self.style.SUCCESS(f'Demo user credentials:'))
        self.stdout.write(self.style.SUCCESS(f'  Username: demo_user'))
