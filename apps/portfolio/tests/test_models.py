...
class TestUserProfile:
    ...
    def test_create_user_profile(self, user):
        ...
        profile = UserProfile.objects.create(
            user=user, first_name="Jane", last_name="Smith", bio="Test bio", email="jane@example.com"
        )
...
class TestSkill:
    ...
    def test_create_skill(self, user):
        ...
        skill = Skill.objects.create(
            user=user, name="JavaScript", category="programming", proficiency="advanced", level=8
        )
    ...
    def test_skill_unique_constraint(self, user, skill):
        ...
        with pytest.raises(Exception):
            Skill.objects.create(
                user=user, name="Python", category="programming", proficiency="expert", level=9  # Same as fixture
            )
...
class TestBlogPost:
    ...
    def test_create_blog_post(self, user):
        ...
        post = BlogPost.objects.create(
            author=user, title="Test Post", slug="test-post", content="Content here", status="draft", tags="tag1, tag2"
        )
