...
class Skill(TimeStampedModel):
    ...
    level = models.IntegerField(
        validators=[MinValueValidator(1), MaxValueValidator(10)], default=5, help_text="Skill level from 1 to 10"
    )
    description = models.TextField(blank=True)
    years_of_experience = models.DecimalField(
        max_digits=4, decimal_places=1, null=True, blank=True, help_text="Years of experience with this skill"
    )
